...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/paises`, {
...
Country.belongsToMany(Activity, { through: "intermedio" })
Activity.belongsToMany(Country, { through: "intermedio" })
